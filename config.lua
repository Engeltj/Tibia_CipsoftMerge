...
-- Market
marketOfferDuration = 90 * 24 * 60 * 60
premiumToCreateMarketOffer = "no"
checkExpiredMarketOffersEachMinutes = 180
maxMarketOffersAtATimePerPlayer = 1000

-- MySQL
mysqlHost = "127.0.0.1"
mysqlUser = "root"
mysqlPass = "seq092uel15"
mysqlDatabase = "tibia2"
mysqlPort = 3306
mysqlSock = ""
passwordType = "sha1"
...
ownerName = "Tim"
ownerEmail = ""
url = "http://tibia.depthsonline.com"
location = "Canada"
