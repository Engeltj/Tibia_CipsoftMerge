...
local function greetCallback(cid)
	...
	if level < 20 then
		npcHandler:say("CHILD! COME BACK WHEN YOU HAVE GROWN UP! YOU NEED LEVEL 20 TO PROCEED", cid)
...
local function creatureSayCallback(cid, type, msg)
	...
	if npcHandler.topic[cid] == 0 then
		if msgcontains(msg, "yes") then
			npcHandler:say("IN WHICH TOWN DO YOU WANT TO LIVE: {CARLIN}, {THAIS}, {VENORE}, {KAZORDOON}, {LIBERTY BAY}, {ANKRAHMUN}, {DARASHIA}, {SVARGROND}, {EDRON}, {PORT HOPE}, {AB'DENDRIEL}, OR {YALAHAR}?", cid)
